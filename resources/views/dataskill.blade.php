          ...
          <div class="card">
            <div class="card-body">
              <form action="/insertdataskill" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                  <label for="exampleInputskill" class="form-label">Skill</label>
                  <input type="text" name="skill" class="form-control" id="exampleInputskill" aria-describedby="emailHelp">
                </div>
                <div class="mb-3">
                  <label for="exampleInputrating" class="form-label">Rating</label>
                  <input type="text" name="rating" class="form-control" id="exampleInputrating" aria-describedby="emailHelp">
                </div>
                </div>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <a href="/deleteskill/{{ $row->id }}" type="button" class="btn btn-danger delete" data-id="{{ $row->id }}">Delete</a>
              </td>
            </tr>
            @endforeach
          </tbody>
