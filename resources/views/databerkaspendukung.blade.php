                    ...
                    <div class="card-body">
                        <form action="{{ route('insertberkaspendukung', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" name="sertifikat" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ $data->sertifikat }}">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Surat Rekomendasi</label>
                                <input type="file" name="suratrekomendasi" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ $data->suratrekomendasi }}">
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label">Portofolio</label>
                                <input type="file" name="portofolio" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" value="{{ $data->portofolio }}">
                            </div>
                            <a href="/output" type="button" class="btn btn-primary">Submit</a>
                        </form>
                        <div>
                            <a href="{{ route('tambahdatapekerjaan', ['id' => $data->id]) }}"
